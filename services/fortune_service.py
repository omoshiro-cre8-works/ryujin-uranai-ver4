...
- things_to_remember には、今回の鑑定書を手元に残しておくと後から読み返しやすく、少し時間を置いてから読み返すと新しく目に留まることがあり、また流れを見返したくなったときの手がかりになる、という静かな導線を自然に含める。
...
- 「そなた」「龍神の力」「無限の可能性」「恐れることはない」「大いなる潮流」などの強い語りかけや壮大すぎる比喩は控えめにする。
